...
// Dummy async function to simulate fetching staff name
async function getStaffName() {
  return new Promise(resolve => {
    setTimeout(() => {
      resolve('Mr. Smith'); // fetched staff name
    }, 1000);
  });
}
    ...
    <Animated.View style={[styles.container, { 
      ...
      <Animated.View style={[
        ...
        <Text style={[styles.title, { color: theme.text }]}>
          <Icon name="school" size={26} color={theme.text} /> Staff Dashboard
        </Text>
        {staffName ? (
      ...
      <View style={styles.cardsContainer}>
        ...
        <Animated.View style={{ 
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('StaffViewAttendance')}
        ...
        <Animated.View style={{ 
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('ModifyAttendance')}
      ...
      <View style={styles.footer}>
        <Text style={[styles.footerText, { color: theme.text }]}>
          Have a productive day! <Icon name="rocket" size={16} color={theme.icon} />
        </Text>
      </View>
    </Animated.View>
  );
